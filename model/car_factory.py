...
class CarFactory:
    ...
    @classmethod
    def create_calliope(cls, last_service_date, current_mileage, last_service_mileage):
    ...
    @classmethod
    def create_thovex(cls, last_service_date, current_mileage, last_service_mileage):
